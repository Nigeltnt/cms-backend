    ...
    <div class="header-container container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        ...
        @foreach($navBarSections as $navBarSection)
          <li><a href="{{$navBarSection->path}}" class="active">{{$navBarSection->name}}</a></li>
        @endforeach    
  ...
  <main class="main">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row align-items-center">
          <div class="col-lg-6">
            <div class="hero-content" data-aos="fade-up" data-aos-delay="200">
              ...
              <h1 class="mb-4">
                ...
                <span class="accent-text">{{$heroSection->subtitle}}</span>
              </h1>
              ...
              <div class="hero-buttons">
                <a href="#about" class="btn btn-primary me-0 me-sm-2 mx-1">{{$heroSection->button_text}}</a>
          ...
          <div class="col-lg-6">
            ...
            <img src="{{ asset('assets/' . $heroSection->image) }}" alt="Hero Image" class="img-fluid">
            {{--<img src="{{ asset('public/' . $heroSection->image) }}" alt="Hero Image" class="img-fluid">--}}
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4 align-items-center justify-content-between">
          ...
          <div class="col-xl-5" data-aos="fade-up" data-aos-delay="200">
            <span class="about-meta">{{$aboutUs->title}}</span>
            <h2 class="about-title">{{$aboutUs->subtitle}}</h2>
            <p class="about-description">{{$aboutUs->description}}</p>

            <div class="row feature-list-wrapper">
              <div class="col-md-6">
                <ul class="feature-list">
                  <li><i class="bi bi-check-circle-fill"></i> {{$aboutUs->title}}</li>
          ...
          <div class="col-xl-6" data-aos="fade-up" data-aos-delay="300">
            <div class="image-wrapper">
              <div class="images position-relative" data-aos="zoom-out" data-aos-delay="400">
                ...
                <img src="{{ asset('assets/' . $aboutUs->image) }}" alt="Business Meeting" class="img-fluid main-image rounded-4">
                <img src="{{ asset('assets/' . $aboutUs->image2) }}" alt="Team Discussion" class="img-fluid main-image rounded-4">
    ...
    <section id="features" class="features section">
      ...
      <div class="container">
        ...
        <div class="d-flex justify-content-center">
          ...
          <ul class="nav nav-tabs" data-aos="fade-up" data-aos-delay="100">
                  ...
                  @foreach($features as $key => $feature)
                    <li class="nav-item">
                      <a class="nav-link {{ $key == 0 ? 'active show' : '' }}" data-bs-toggle="tab" data-bs-target="#feature_{{$feature->id}}">
                        <h4>{{ $feature->title }}</h4>
                      </a>
                    </li><!-- End tab nav item -->
                  @endforeach
        ...
        @foreach($features as $key => $feature)
          <div class="tab-pane fade {{ $key == 0 ? 'active show' : '' }}" id="feature_{{$feature->id}}">
            <div class="row">
        ...
        <div class="row gy-4">
            @foreach($accolades as $accolade)
                <div class="col" data-aos="zoom-in" data-aos-delay="400">
                    <div class="{{ $accolade->color }}">
                        <i class="{{ $accolade->icon }}"></i>
                        <h4>{{ $accolade->name }}</h4>
    ...
    <section id="features-2" class="features-2 section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-4">
            @if(isset($specks))
            @foreach($specks as $speck)

            <div class="feature-item text-end" data-aos="fade-right" data-aos-delay="400">
              <div class="d-flex align-items-center justify-content-end gap-4">
                <div class="feature-content">
                  <h3>{{$speck->name}}</h3>
                  <p>{{$speck->description}}</p>
                </div>
                <div class="feature-icon flex-shrink-0">
                  <i class="{{$speck->icon}}"></i>
                </div>
              </div>
